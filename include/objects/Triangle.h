...
public:
    Triangle() = default;
    Triangle(glm::vec3 v0, glm::vec3 v1, glm::vec3 v2, glm::vec3 n0, glm::vec3 n1, glm::vec3 n2, std::shared_ptr<Material> mat) : p0(v0), p1(v1), p2(v2), n(n0 + n1 + n2 / glm::vec3(3.0f, 3.0f, 3.0f)), mat(mat)
    {}
